...
SRCS = main.cpp server.cpp client.cpp channel.cpp convert.cpp PRIVMSG.cpp PASS.cpp\
 NICK.cpp USER.cpp KICK.cpp INVITE.cpp JOIN.cpp TOPIC.cpp tools.cpp BOT.cpp PART.cpp QUIT.cpp MODE.cpp
OBJS = $(SRCS:.cpp=.o)
NAME = ircserv
